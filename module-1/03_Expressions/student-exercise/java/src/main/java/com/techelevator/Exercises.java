...
public class Exercises {
	...
	public int max1020(int a, int b) {
		...
		if((((a > b)|| (b >= 20)) && (a <= 20)) && (((a >= 10) && (a <= 20)) || ((b >= 10) && (b <= 20)))) {
			return a;
		}
		if((((b > a)|| (a >= 20)) && (b <= 20)) && (((a >= 10) && (a <= 20)) || ((b >= 10) && (b <= 20)))) {
			return b;
		}
		return 0;
	}
	...
	public int caughtSpeeding(int speed, boolean isBirthday) {
		...
		if((!isBirthday && (speed >= 61) && (speed <= 80)) || (isBirthday && (speed >= 66) && (speed <= 85))) {
			return smallTicket;
		}
		if((!isBirthday && speed >= 81) || (isBirthday && (speed >= 86))) {
			return bigTicket;
		}
		return 0;
	}
	...
	public boolean answerCell(boolean isMorning, boolean isMom, boolean isAsleep) {
		...
		if((!isAsleep && isMom) || (!isAsleep && !isMorning)) {
			return true;
		}
		return false;
	}
	...
	public boolean twoAsOne(int a, int b, int c) {
		...
		if((a + b == c) || (a + c == b) || (b + a == c) || (a + c == a) || (c + a == b) || (c + b == a)) {
			return true;
		}
		return false;
	}
