...
public class Exercises {
	...
	public boolean firstLast6(int[] nums) {
		...
		int lastBox = nums.length - 1;
		int firstBox = nums[0];
		
		if(nums[lastBox] == 6 || firstBox == 6) {
				return true;
			}
		return false;
	}
	...
	public boolean sameFirstLast(int[] nums) {
		...
		if((firstValue == nums[lastBox]) && (lastBox >= 1)) {
			return true;
		}
		return false;
	}
	...
	public boolean commonEnd(int[] a, int[] b) {
		...
		if((a[lastA] == b[lastB]) || (firstAValue == firstBValue)) {
			return true;
		}
		return false;
	}
	...
	public int sum3(int[] nums) {
		...
		int sumOf3 = nums[0] + nums[1] + nums[2];
	...
	public int[] reverse3(int[] nums) {
		...
		int[] reverseArray = new int[] {last, middle, first};
	...
	public int[] maxEnd3(int[] nums) {
		...
		int first = nums[0];
		int last = nums[2];
		int[] firstIsLarger = new int[] {first, first, first};
		int[] lastIsLarger = new int[] {last, last, last};
	...
	public int[] middleWay(int[] a, int[] b) {
		...
		int[] newArray = new int[] {aElement, bElement};
